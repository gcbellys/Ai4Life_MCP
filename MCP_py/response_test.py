...
# 定义系统提示词（从 restaurant_prompt.txt 复制）
...
# 初始化 OpenAI 客户端
client = OpenAI(base_url="http://localhost:8000/v1", api_key="abcd1234")
